...
<div class="py-6 max-w-7xl mx-auto sm:px-6 lg:px-8 bg-opacity-25 grid grid-cols-1 md:grid-cols-2">
    {{-- Button New Product --}}
        ...
        disabled:opacity-25 transition ml-3 mr-3">
            {{__('New Product')}}
        </a>
        </div>
        ...
        <div class="ml-auto mr-3 flex flex-col gap-2 w-auto border-b-2 border-indigo-700">
            <div class="bg-blue-50 rounded-t text-blue-900 px-4 py-3" role="alert">
                <div class="flex items-center">
                    <div>
                        <svg class="fill-current h-5 w-5 text-indigo-700" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M2.93 17.07A10 10 0 1 1 17.07 2.93 10 10 0 0 1 2.93 17.07zm12.73-1.41A8 8 0 1 0 4.34 4.34a8 8 0 0 0 11.32 11.32zM9 11V9h2v6H9v-4zm0-6h2v2H9V5z" /></svg>
                    </div>
                    <div> 
                                                ...
                                                <div class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                                    <!-- Authentication -->
                                                        <form method="POST" action="{{ route('products.destroy', ['product'=>$product->id]) }}">
                                                            ...
                                                            <a href="{{ route('products.destroy', ['product'=> $product->id])}}" @click.prevent="$root.submit();">
                                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
