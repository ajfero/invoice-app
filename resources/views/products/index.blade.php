                ...
                @foreach ($products as $product)
                    ...
                    {{-- id --}}
                        <td class="py-3 px-6 text-left whitespace-nowrap">
                            <div class="flex items-center">
                                ...
                                <span class="font-medium">{{ $product->id, 4 , 0, STR_PAD_LEFT }}</span>
                            </div>
                        </td>
                    ...
                    {{-- Edit --}}
                        <div class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                            {{-- En este caso haremos englobaremos el boton de editar con la etiqueta a que conbertira la imagen en un link
